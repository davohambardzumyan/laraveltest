        ...
        >
            <v-card>
                ...
                >
                    ...
                    <v-toolbar-title>Create New Ticket</v-toolbar-title>
                    <v-spacer></v-spacer>
                    <v-toolbar-items>
                        <v-btn
                            dark
                ...
                <v-row>
                    ...
                    >
                        <v-card class="ma-5 pa-5">
                            ...
                            ></v-autocomplete>
                            <v-select
                                v-model="form.settings.priority"
                                :items="allPriorities"
                                label="Priority *"
                                :rules="[rules.required]"
                            ></v-select>
                            ...
                            ></v-select>
                            <v-select
                                v-model="form.settings.status"
                                :items="allStatuses"
                                label="Status *"
                                :rules="[rules.required]"
                            ></v-select>
                            <v-textarea
                                v-model="form.settings.note"
                                label="Note *"
                                :rules="[rules.required]"
                            ></v-textarea>
                        </v-card>
    ...
    methods: {
        ...
        submit() {
            ...
            if (this.$refs.createForm.validate() && this.isEditorValid) {
                this.loading = true;
                ticketRepository.create(this.form).then(()=>{
